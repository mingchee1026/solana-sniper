...
import {createLimitTransaction} from '../../../transactions/limit';
...
export const createLimit = async (
  ...
  try {
    ...
    const inAmount = BigInt(user.selectedInputAmount); // BigInt(5_000_000); // buy a total of 5 USDC over 5 days
    const outAmount = BigInt(user.selectedLimitOutAmount); // BigInt(1_000_000); // buy using 1 USDC each day
